...
import com.ctre.phoenixpro.controls.PercentSupplyVoltageRequest;
import com.ctre.phoenixpro.controls.VelocityPercentSupplyVoltageRequest;
...
public class Intake extends SubsystemBase {
    ...
    private Intake() {
        ...
        liftMotor = new TalonFX(Constants.INTAKE_LIFT_MOTOR_CAN_ID, null);
    ...
    public void setRollerSpeed(double speed) {
        ...
        this.intakeMotor.setControl(request);
        //this.intakeMotor.set(ControlMode.PercentOutput, speed);
        //System.out.println("Set Intake Speed = " + speed);
    }

    public void resetIntakeEncoder() {
        this.intakeMotor.getConfigurator().setSensorPosition(0);
        //this.intakeMotor.setSelectedSensorPosition(0);
    }

    public double getRollerRotations() {
        return intakeMotor.getPosition().getValue() / Constants.ENCODER_TICKS_PER_MOTOR_REVOLUTION / INTAKE_ROLLER_OUTPUT_TO_ENCODER_RATIO;
    ...
    public double getRollerRPM() {
        return intakeMotor.getVelocity().getValue() / INTAKE_ROLLER_REVOLUTIONS_TO_ENCODER_TICKS * 10.0 * 60.0;
