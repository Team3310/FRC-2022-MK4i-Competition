...
public class Shooter extends SubsystemBase {
    ...
    private Shooter() {
        shooterMotorMaster = new TalonFX(Constants.SHOOTER_MASTER_CAN_ID, null);
        shooterMotorSlave = new TalonFX(Constants.SHOOTER_SLAVE_CAN_ID, null);
        hoodMotor = new TalonFX(Constants.HOOD_MOTOR_CAN_ID, null);
        ...
        shooterMotorMaster.getConfigurator().
